...
export function ChatHeader({
  ...
  return (
    <header className="shrink-0 border-b-2 border-[var(--team-chat-line)] bg-[var(--orbita-chrome)]">
      ...
      {searchOpen && (
        <div className="mt-0 border-t border-[var(--team-chat-line)] px-4 pb-3 pt-2">
