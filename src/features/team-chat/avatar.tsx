...
export function Avatar({
  ...
  return (
    ...
    >
      <div
        className="relative flex size-full items-center justify-center overflow-hidden border border-border font-display font-bold leading-none"
        style={{
          background: tone.bg,
          color: tone.fg,
...
export function GroupGlyph({ seed, size = 40 }: { seed: string; size?: number }) {
  ...
  return (
    <div
      className="grid shrink-0 place-items-center border border-border"
      style={{
        width: size,
        height: size,
        borderRadius: "50%",
