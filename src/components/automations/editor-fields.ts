...
export const CONDITION_FIELDS: Opt[] = [
  ...
  { value: "contact.adUtmSource", label: "utm_source", group: "Rastreio" },
  { value: "contact.adUtmMedium", label: "utm_medium", group: "Rastreio" },
  { value: "contact.adUtmCampaign", label: "utm_campaign", group: "Rastreio" },
  { value: "contact.adUtmContent", label: "utm_content", group: "Rastreio" },
  { value: "contact.adUtmTerm", label: "utm_term", group: "Rastreio" },
  { value: "contact.utmId", label: "utm_id", group: "Rastreio" },
  { value: "contact.utmReferrer", label: "utm_referrer", group: "Rastreio" },
  { value: "contact.referrer", label: "referrer", group: "Rastreio" },
  { value: "contact.gclid", label: "gclid", group: "Rastreio" },
  { value: "contact.fbclid", label: "fbclid", group: "Rastreio" },
  { value: "contact.googleClientId", label: "gclientid", group: "Rastreio" },
  { value: "contact.ttadId", label: "ttad_id", group: "Rastreio" },
  { value: "contact.ttadName", label: "ttad_name", group: "Rastreio" },
  // Negócio
