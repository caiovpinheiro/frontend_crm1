    ...
    return (
      <div className={cn("relative w-full", className)}>
        ...
        <input
          ...
          className="h-10 w-full rounded-full border border-[var(--glass-border)] bg-[var(--glass-bg-overlay)] pl-9 pr-4 font-body text-[13px] text-[var(--text-primary)] shadow-none outline-none placeholder:text-[var(--text-muted)] transition-[box-shadow] duration-150 focus:shadow-[0_1px_8px_rgba(0,0,0,0.12)]"
        />
      </div>
    );
  }
